...
$("#pizzatotal").append("Dear customer Your bill is sh. "+checkoutTotal);
});
...
console.log("Your total pay sh. "+deliceryamount+" on delivery");
$("#totalbill").append("Your bill plus delivery fee is: "+deliceryamount +" please provide us direction Information for delivery")
});
...
$("#message").append("Dear Customer your order has been recieved successfully received and it will be delivered to you at "+location+ ". pay this on delivery sh. "+deliceryamount);
$("#totalbill").hide();
